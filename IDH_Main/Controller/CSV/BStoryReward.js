...
module.exports.Load = function (fs) {
    ...
    //!< 동기 사용.
    var data = fs.readFileSync(process.cwd() + '/Resources/CSV/BStoryReward.txt', 'utf8');
    if (data != null) {
        var row = data.split('\r\n');
        var col;
        ...
        for (var idx = 0; idx < row.length; idx++) {
            ...
            temp = {
                ...
                reward_id1: Number(col[1]),                     // 보상 아이템 ID
                reward_id1_value: Number(col[2]),               // 보상 아이템 수량
                reward_id1_probability: Number(col[3]),         // 보상 아이템 획득 확률
                reward_id1_probability_out: Number(col[4]),     // 보상 아이템 안 나올 확률
